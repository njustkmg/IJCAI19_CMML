...
parser.add_argument('--superviseunsuperviseproportion', type = str, default = '2, 8')#ratio of supervise data to unsupervise data
...
if __name__ == '__main__':
    ...
    dataset = Data.MyDataset(args.imgfilenamerecord, args.imgfilename, args.textfilename, args.labelfilename, train = True, supervise = True, traintestproportion = args.traintestproportion, superviseunsuperviseproportion = superviseunsuperviseproportion)
    ...
    Textfeaturemodel, Imgpredictmodel, Textpredictmodel, Imgmodel, Attentionmodel, Predictmodel = Model.generate_model(Textfeatureparam, Imgpredictparam, Textpredictparam, Attentionparam, Predictparam)
